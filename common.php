...
<body>
	...
	<div class="button">
		...
		<a href="logout.php"><input type="submit"  name="submit" value="Logout" class="submit"></a>
   </div>
    ...
    <div class="sidebar">
		...
		<a href="profile.php">Profile</a>
  		<a href="lodgecomplaint.php">Lodge Complaint</a>
  		<a href="studentstatus.php">Complaint Status</a>  		
  	</div>
